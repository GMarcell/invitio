...
export function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[92vh] overflow-hidden bg-[#071827]"
    >
      <Image
        src="/images/wedding/hero-background.jpeg"
      ...
      <div className="relative z-10 mx-auto flex min-h-[92vh] max-w-6xl flex-col items-center justify-center px-5 pb-20 pt-24 text-center text-[#F4EFE5]">
        <h1 className="hero-rise mt-4">
          <span className="block font-script text-6xl leading-none sm:text-8xl">
            Wedding
          </span>
